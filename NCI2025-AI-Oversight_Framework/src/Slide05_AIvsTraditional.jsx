...
const StepDot = styled.div`
  ...
  /* Add a background mask to hide the line */
  &::before {
    content: '';
    position: absolute;
    width: calc(100% + 8px);
...
const Slide5 = () => {
  const { step } = useSlideAnimation(3, 'slide-5-ai-vs-traditional');
    ...
    >
      <MainContainer>
        ...
        <ComparisonContainer>
          ...
          <VSBadge $visible={true} $delay="0.4s">VS</VSBadge>
          ...
          <KeyInsight $visible={true} $delay="0.8s">
            <InsightText>
