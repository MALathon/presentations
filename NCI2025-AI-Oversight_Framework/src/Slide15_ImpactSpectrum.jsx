...
const Slide13_ImpactSpectrum = () => {
  const { step } = useSlideAnimation(8, 'slide-15-impact-spectrum');
    ...
    >
      ...
      <SpectrumContainer>
        ...
        <ImpactLevels>
          ...
          <OversightIndicator $visible={true} $delay="0.6000000000000001s">
            <OversightText>
...
export default Slide13_ImpactSpectrum;