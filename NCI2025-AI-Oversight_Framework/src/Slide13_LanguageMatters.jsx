...
const ColumnHeader = styled.div`
  ...
  &::before {
    ...
    bottom: -2px;
    background: ${props => props.$clinical ? 
      'linear-gradient(45deg, rgba(255, 67, 67, 0.5), transparent)' :
      'linear-gradient(45deg, rgba(76, 175, 80, 0.5), transparent)'
    };
    border-radius: 16px;
    opacity: 0;
...
const ColumnTitle = styled.h2`
  font-size: 16px;
  font-weight: 600;
  color: ${props => props.$clinical ? '#FF6B6B' : props.$ambiguous ? '#FFC107' : '#4CAF50'};
  margin: 0;
  display: flex;
  align-items: center;
  gap: 6px;
...
const Slide11_LanguageMatters = () => {
  const { step } = useSlideAnimation(8, 'slide-13-language-matters');
...
export default Slide11_LanguageMatters;