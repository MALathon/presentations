...
const Slide05_IRBCriteria = () => {
  ...
  const criteria = [
    {
      ...
      ref: '21 CFR 812, 820',
      desc: 'Software intended for diagnosis, treatment, prevention, or mitigation of disease',
      ai: 'Compliance with FDA Quality System Regulation design controls and determination of significant risk vs non-significant risk device classification.',
      critical: true,
      category: 'definition',
      icon: DeviceIcon
    },
    {
      ...
      ai: 'Whether the activity involves living individuals about whom an investigator obtains data through intervention or interaction, or identifiable private information.',
      critical: true,
      category: 'definition',
    ...
    },
    {
      ...
      ai: 'Whether machine learning model training constitutes a systematic investigation designed to develop or contribute to generalizable knowledge.',
      critical: true,
      category: 'definition',
      icon: ResearchIcon
    },
    {
      ...
      ai: 'Assessment that risks are minimized using procedures consistent with sound research design and do not unnecessarily expose subjects to risk.',
      critical: false,
      category: 'risk',
      icon: RiskIcon
    },
    {
      ...
      ai: 'Equitable selection ensuring no unjust exclusion based on race, gender, or economic status, with attention to fair distribution of research burdens and benefits.',
      critical: false,
      category: 'subject',
      icon: EquityIcon
    },
    {
      ...
      ai: 'Informed consent documentation containing all required elements including reasonably foreseeable risks and disclosure of data retention.',
      critical: false,
      category: 'subject',
      icon: ConsentIcon
    },
    {
      ...
      ai: 'Adequate provisions for monitoring data collection to ensure safety, including periodic review of model performance metrics and adverse event reporting.',
      critical: false,
      category: 'risk',
      icon: MonitorIcon
    },
    {
      ...
      ai: 'Adequate provisions to protect privacy and maintain confidentiality, including HIPAA compliance and appropriate administrative, physical, and technical safeguards.',
      critical: false,
      category: 'subject',
      icon: PrivacyIcon
    },
    {
      ...
      ai: 'Additional safeguards when vulnerable subjects are involved, including protections under Subparts B (pregnant women), C (prisoners), and D (children).',
      critical: false,
      category: 'subject',
      icon: VulnerableIcon
    }
  ...
  const getNodePosition = (index, total) => {
    ...
    const x = 190 + radius * Math.cos(radian);
  ...
  return (
    ...
    >
          ...
          <DetailPanel $show={selectedData}>
            <DetailHeader>
              ...
              <DetailTitleSection>
                ...
                <RegBadge>
                  <RegTag $highlight={true}>{selectedData.ref}</RegTag>
                </RegBadge>
              </DetailTitleSection>
            </DetailHeader>
      ...
      <InteractionHint>
        <kbd>Tab</kbd> Navigate criteria <span className="separator">|</span> <kbd>1-9</kbd> Jump <span className="separator">|</span> Click tabs to filter
      </InteractionHint>
