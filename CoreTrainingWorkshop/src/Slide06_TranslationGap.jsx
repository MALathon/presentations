...
const Slide06_TranslationGap = () => {
  const { step } = useSlideAnimation(6, 'slide-6-translation-gap');
  ...
  return (
    ...
    >
      ...
      <Notes>
        ...
        This slide demonstrates the communication gap between
        ...
        The visual gap emphasizes the translation challenge.
      </Notes>
    </SlideWrapper>
  );
};

export default Slide06_TranslationGap;
